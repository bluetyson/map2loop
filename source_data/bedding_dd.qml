...
<qgis styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" version="3.12.3-București" minScale="100000000" labelsEnabled="0" readOnly="0" maxScale="0" simplifyLocal="1" simplifyDrawingHints="0" simplifyMaxScale="1">
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="angle" type="Map">
                  ...
                  <Option name="expression" value="&quot;dip_dir&quot;  -90" type="QString"/>
  ...
  <aliases>
    ...
    <alias field="l" name="" index="2"/>
    <alias field="m" name="" index="3"/>
    <alias field="n" name="" index="4"/>
    <alias field="dip" name="" index="5"/>
    <alias field="dip_dir" name="" index="6"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="m" expression="" applyOnUpdate="0"/>
    <default field="n" expression="" applyOnUpdate="0"/>
    <default field="dip" expression="" applyOnUpdate="0"/>
    <default field="dip_dir" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="l" notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="m" notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="n" notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="dip" notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="dip_dir" notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" field="X" exp=""/>
    <constraint desc="" field="Y" exp=""/>
    <constraint desc="" field="l" exp=""/>
    <constraint desc="" field="m" exp=""/>
    <constraint desc="" field="n" exp=""/>
    <constraint desc="" field="dip" exp=""/>
    <constraint desc="" field="dip_dir" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="l" width="-1" hidden="0" type="field"/>
      <column name="m" width="-1" hidden="0" type="field"/>
      <column name="n" width="-1" hidden="0" type="field"/>
      <column name="dip_dir" width="-1" hidden="0" type="field"/>
    </columns>
